...
CREATE DATABASE LINK yellowcom_paolo CONNECT TO yellowcom
IDENTIFIED BY yellowcom USING '192.168.1.13:1521/orcl';

SELECT customer.surname, contract.customer FROM customer@yellowcom_paolo, contract WHERE customer.surname=contract.customer.surname;
COMMIT; --dato il 2PC (two phase commit) protocol è necessario fare il commit per confermare la transazione
