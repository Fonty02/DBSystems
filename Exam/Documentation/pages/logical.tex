...
\end{table}
\noindent Total Cost: (500+1+1+1+1+9000+9000)*0.03=555.12 per day
\newline
...
\newline
\noindent So the total cost without redundancy is 3.602.000 + 555.12 = 3.602.555.12, while the total cost with redundancy is 3.602.400 + 15.12 = 3.602.415.12 per day.
So we should keep the redundancy in this case. 
\newline
